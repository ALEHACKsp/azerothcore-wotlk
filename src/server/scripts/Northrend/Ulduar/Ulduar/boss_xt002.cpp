...
public:
    ...
    struct boss_xt002AI : public ScriptedAI
    {
        ...
        void JustDied(Unit * /*victim*/) override
        {
            ...
            me->MonsterYell(u8"你是个非常...非常...坏的坏...玩具", LANG_UNIVERSAL, 0);
        ...
        void DoAction(int32 param)
        {
            ...
            if (param == ACTION_HEART_BROKEN)
            {
                ...
                me->MonsterTextEmote(u8"XT-002 拆解者的心脏和它脱离了.", 0, true);
            ...
            switch(events.GetEvent())
            {
                ...
                case EVENT_HEALTH_CHECK:
                    ...
                    if (me->HealthBelowPct(_healthCheck))
                    {
                        ...
                        me->MonsterYell(u8"太累了。我得休息一会儿！", LANG_UNIVERSAL, 0);
                ...
                case EVENT_TYMPANIC_TANTARUM:
                    ...
                    me->MonsterTextEmote(u8"XT-002 拆解者开始制造地震", 0, true);
                    me->MonsterYell("NO! NO! NO! NO! NO!", LANG_UNIVERSAL, 0);
                ...
                case EVENT_ENRAGE:
                    ...
                    me->MonsterYell(u8"我和这群玩具玩累了!我再也不想和它们玩了", LANG_UNIVERSAL, 0);
                ...
                case EVENT_START_SECOND_PHASE:
                    ...
                    me->MonsterTextEmote(u8"XT-002 的心脏暴露了在外面并且在泄漏能量", 0, true);
                ...
                case EVENT_RESTORE:
                    ...
                    me->MonsterYell(u8"我准备好玩一玩了！", LANG_UNIVERSAL, 0);
