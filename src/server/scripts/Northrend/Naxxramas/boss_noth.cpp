        ...
        void UpdateAI(uint32 diff)
        {
            ...
            switch (events.GetEvent())
            {
                ...
                case EVENT_SUMMON_PLAGUED_WARRIOR_ANNOUNCE:
                    ...
                    me->MonsterTextEmote(u8"%s 召唤了四个骷髅战士!", 0, true);
                    Talk(SAY_SUMMON);
                    events.RepeatEvent(25000);
                ...
                case EVENT_MOVE_TO_BALCONY:
                    ...
                    me->MonsterTextEmote(u8"%s 传送到了露台上方!", 0, true);
                ...
                case EVENT_SPELL_BLINK:
                    ...
                    me->MonsterTextEmote(u8"%s 闪现!", 0, true);
                ...
                case EVENT_BALCONY_SUMMON_ANNOUNCE:
                    ...
                    me->MonsterTextEmote(u8"%s 更多的骷髅出现了!", 0, true);
                    events.RepeatEvent(25000);
                ...
                case EVENT_MOVE_TO_GROUND:
                    ...
                    me->MonsterTextEmote(u8"%s 传送回了战场!", 0, true);
                    StartGroundPhase();
