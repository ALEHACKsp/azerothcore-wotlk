...
#define TEXT_AGGRO                                  u8"天！车间太乱了！真尴尬！"
#define TEXT_BERSERK                                u8"天! 我的朋友们我们没时间了!"
#define TEXT_HARDMODE                               u8"你为什么要去做那样的事？你没看到说'别推这个按钮'的牌子吗！我们如何完成测试在这种自毁机制启动的情况下？"
#define TEXT_LMK2_ACTIVATE                          u8"我们没时间了，朋友们！你会帮助我测试我最新的最伟大的创作。现在，在你改变主意之前，记住，这是你用XT-002制造烂摊子之后，你欠我的。"
#define TEXT_LMK2_SLAIN_1                           u8"MEDIC!"
#define TEXT_LMK2_SLAIN_2                           u8"我可以修好…或者，也许不是！一团糟…"
#define TEXT_LMK2_DEATH                             u8"好极了！结果不错！赫尔完好无损98.9%！几乎没什么凹痕！马上走。"
#define TEXT_VX001_ACTIVATE                         u8"看Vx-001杀伤人员突击炮！你可能要掩护。"
#define TEXT_VX001_SLAIN_1                          u8"很有趣。我认为他们称之为 \"clean kill\"."
#define TEXT_VX001_SLAIN_2                          u8"记着：大炮对肉很有效。"
#define TEXT_VX001_DEATH                            u8"谢谢，朋友们！你的努力产生了一些奇妙的数据！现在，我把数据放在哪？...就在那儿！"
#define TEXT_ACU_ACTIVATE                           u8"不漂亮吗？我称之为壮观的空中指挥单位！"
#define TEXT_ACU_SLAIN_1                            u8"玩大了！"
#define TEXT_ACU_SLAIN_2                            u8"你能做得更好!"
#define TEXT_ACU_DEATH                              u8"初步测试阶段完成。真正的考验！"
#define TEXT_VOLTRON_ACTIVATE                       u8"看看这光荣的杰作！我来介绍你…V-07-TR-0N"
#define TEXT_VOLTRON_SLAIN_1                        u8"Prognosis: Negative!"
#define TEXT_VOLTRON_SLAIN_2                        u8"你不会从那里爬出来的，朋友。"
#define TEXT_VOLTRON_DEATH                          u8"看来我有点误判了。我让我的思想被监狱里的恶魔破坏，压倒了我的主要指令。所有系统现在似乎都功能正常了。"
